...
const ListProduct = () => {
  ...
  useEffect(() => {
    const allProducts = JSON.parse(localStorage.getItem('products')) || productsData;

    // Nếu localStorage chưa có thì lưu lại
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        {products.length > 0 ? (
          ...
          <p className="text-center col-span-4">Không tìm thấy sản phẩm</p>
        )}
      </div>
    </div>
  );
